...
DEFAULT_BASE = Path("./glyphs/5x5_filled_corners")
...
def main():
	...
	ap.add_argument("--cols", type=int, default=30, help="number of glyphs across (X)")
	ap.add_argument("--rows", type=int, default=30, help="number of glyphs down (Y)")
